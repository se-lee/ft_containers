...
/*
	template<class T>
	class const_vector_iterator : public std::iterator<ft::random_access_iterator_tag, Iterator>
	{
		public:
			typedef ft::random_access_iterator_tag	iterator_category;
			typedef T								value_type;
		...
		public:
			...
			explicit const_vector_iterator(pointer it) : _current(it) {}
		
			template<class Iter>
			const_vector_iterator(const const_vector_iterator<Iter> &vec_it)
			{
				*this = vec_it;
			}
